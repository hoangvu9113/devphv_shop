(function ($) {
   ...
   // Magnific Popup Image
    ...
    // CartPlusMinus.prepend('<div class="dec qtybutton"><i data-product={{item.product.id}} data-action="remove" class="decrease icon-minus update-cart"></i></i></div>');
    // CartPlusMinus.append('<div class="inc qtybutton"><i data-product={{item.product.id}} data-action="add" class="increase icon-plus update-cart"></i></i></div>');
